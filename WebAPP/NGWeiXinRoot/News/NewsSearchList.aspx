<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewsSearchList.aspx.cs" Inherits="NGWeiXinRoot_News_NewsSearchList" %>
        ...
        <!--search_start-->
         <div class="weui-search-bar weui-search-bar_focusing" id="searchBar">
                <div class="weui-search-bar__box">
                    ...
                    <input runat="server"  class="weui-search-bar__input" id="searchInput" placeholder="搜索" />
            ...
            <a href="javascript:list_news(0);void(0);" class="weui-search-bar__cancel-btn" id="searchCancel">搜索</a>
        </div>
...
<script language="javascript" type="text/javascript">
    function list_news(category_id) {
        ...
        $("#hidKeyword").val(k);
        //alert($("#hidKeyword").val());
        if ($.trim($("#hidKeyword").val()) == "") {return false;}
        layer.load(2); //加载时显示加载效果
        $.ajax({
            type: "get",
            url: "NewsInterface.ashx",
            data: { flag: "list_news", categoryId: category_id, k: escape($("#hidKeyword").val()) },
            dataType: "text",
            async: true,
