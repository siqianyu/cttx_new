<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YqxkjMemberCourse.aspx.cs" Inherits="NGWeiXinRoot_YqxkjMemberCourse" %>
...
<body class="bottom-pd">
    ...
    <asp:HiddenField ID="hid_dirId" runat="server" />
		<p class="title left" style="background:#fff;"><i></i><b>我的课程</b></p>
