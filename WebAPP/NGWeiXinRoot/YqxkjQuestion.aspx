<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YqxkjQuestion.aspx.cs" Inherits="NGWeiXinRoot_YqxkjQuestion" %>
...
<!--课后练习开始-->
		...
		<div class="explain left" id="div_desc" style="color:Red">
			--
		</div>
       
        <div class="btn-bottom">
		<div class="answer-btn left">
			<button id="submit" onclick="to_tj();return false;">提交</button>
...
<script language="javascript" type="text/javascript">
    ...
    function computer_record() {
        var mytype = ("<%=this.source %>" == "mnlx") ? "模拟试题" : "";
        htmlobj = $.ajax({ url: "YqxkjCourseInterface.ashx?flag=computer_record&courseId=" + $("#hidCourseId").val() + "&mid=" + $("#hidMemberId").val() + "&mytype=" + escape(mytype) + "", async: false });
