<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YqxkjMemberCash.aspx.cs" Inherits="NGWeiXinRoot_YqxkjMemberCash" %>
...
<body class="bottom-pd user-body">
    ...
    <asp:HiddenField ID="hid_memberId" runat="server" />
		<!--待使用开始-->
		<p class="title left" style="background:#fff;"><i></i><b>分享佣金（满200可申请提现）</b></p>
            ...
            <ItemTemplate>
			 <li class="to-pick">
			 	<p class="coupon-money">
			 		...
			 		<i>来自：<%#Eval("ShareFirendTrueName")%></i>
			 	</p>
			 	<p class="coupon-info left">
			 		<span class="use"><%#Eval("Remark")%></span>
			 		<span class="use-btn">
			 			<i><%#Eval("CreateTime", "{0:yyyy-MM-dd}").ToString()%></i>
			 			<button onclick="return false;">申请提现</button>
			 		</span>
			 	</p>
			 	<i class="attach"></i>
			 </li>
