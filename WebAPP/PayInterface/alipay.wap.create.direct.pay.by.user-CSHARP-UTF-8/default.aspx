...
<style>
    *{
    ...
    .am-header {
        ...
        box-align: center;font-size: 18px;
    }
    .am-header h1 {
        -webkit-box-flex: 1;
        -ms-flex: 1;
                ...
                <dl class="content">
                    ...
                    <dd id="btn-dd">
                        <span class="new-btn-login-sp">
                            <asp:Button ID="BtnAlipay" name="BtnAlipay" class="new-btn-login" Text="确 认" Style="text-align: center; height:40px;" runat="server" OnClick="BtnAlipay_Click"/>
                        </span>
