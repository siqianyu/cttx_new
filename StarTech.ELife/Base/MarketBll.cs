...
namespace StarTech.ELife.Base
{
    ...
    {
        public MarketDal dal = new MarketDal();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
        //public MarketModel GetModelByCache(string Market_id)
        //{
			
        //    string CacheKey = "T_Base_MarketModel-" + Market_id;
		...
		/// 获得数据列表
		/// </summary>
		public List<MarketModel> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<MarketModel> DataTableToList(DataTable dt)
		{
			List<MarketModel> modelList = new List<MarketModel>();
