...
namespace StarTech.ELife.Goods
{
    public class GoodsTypeDal
    {
        ...
        public GoodsTypeModel GetModel(string CategoryId)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 CategoryId,CategoryName,CategoryLevel,PCategoryId,CategoryPath,RootId,CategoryToTypeId,CategoryFlag,Orderby,Remarks,Url,icon from T_Info_Category ");
            strSql.Append(" where CategoryId=@CategoryId ");
            SqlParameter[] parameters = {
					new SqlParameter("@CategoryId", SqlDbType.VarChar,50)};
            parameters[0].Value = CategoryId;
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM T_Info_Category ");
            if (strWhere.Trim() != "")
            {
