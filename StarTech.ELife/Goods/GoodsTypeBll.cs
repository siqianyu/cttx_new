...
namespace StarTech.ELife.Goods
{
    ...
    {
        private readonly GoodsTypeDal dal=new GoodsTypeDal();
		...
		/// 增加一条数据
		/// </summary>
		public void Add(GoodsTypeModel model)
		{
			dal.Add(model);
		}
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(GoodsTypeModel model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
        public GoodsTypeModel GetModel(string CategoryId)
		{
		...
		/// 获得数据列表
		/// </summary>
        public List<GoodsTypeModel> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<GoodsTypeModel> DataTableToList(DataTable dt)
		{
			List<GoodsTypeModel> modelList = new List<GoodsTypeModel>();
