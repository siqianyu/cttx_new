...
namespace StarTech.ELife.News
{
    public class NewsBll
    {
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        //public NewsModel GetModelByCache(string NewsID)
        //{

        //    string CacheKey = "T_NewsModel-" + NewsID;
        ...
        /// 获得数据列表
        /// </summary>
        public List<NewsModel> DataTableToList(DataTable dt)
        {
