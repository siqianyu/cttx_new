...
namespace StarTech.ELife.Job
{
    ...
    public partial class JobBll
    {
        ...
        ///// 得到一个对象实体，从缓存中
        ///// </summary>
        //public JobModel GetModelByCache()
        //{
        //    //该表无主键信息，请自定义主键/条件字段
        //    string CacheKey = "JobModel-";
        ...
        /// 获得数据列表
        /// </summary>
        public List<JobModel> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<JobModel> DataTableToList(DataTable dt)
        {
