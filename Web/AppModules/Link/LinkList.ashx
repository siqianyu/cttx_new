<%@ WebHandler Language="C#" Class="LinkList" %>
...
public class LinkList : IHttpHandler
{
    ...
    {
        string table = "V_LinkCategory";
        string fields = "LinkId,Title,Link,DisplayMode,Category,Sort";//字段顺序和必须前台jggrid设置的一样
        ...
        return JSONHelper.ToJGGridJson(curPage, totalPages.ToString(), totalRecords.ToString(), dtSource, fields.Split(','), "LinkId");
    }
