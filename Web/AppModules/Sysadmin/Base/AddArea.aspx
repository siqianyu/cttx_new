<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddArea.aspx.cs" Inherits="AppModules_Sysadmin_Base_AddArea" %>
    ...
    <script type="text/javascript">
        ...
        function check() {
            ...
            if (id == "" || id == null) {
                ...
                if (!/[@#\$%\^&\*<\>[\]{\}!,\;]+/g.test(id)) {
                if (oldId == "" || oldId == null || oldId != id) {//是进行添加或者编号被修改了
                    var str = $.ajax({ url: "AreaHandler.ashx?flag=isexist&id=" + id + "", async: false }).responseText;
                    if (str === "true") {
                        alert("此编号已经存在!");
                        return false;
                    }
...
<body>
    ...
    <div id="right">
            ...
            <div class="applica_di">
                ...
                <tr>
                    <td class="Ltd">
                        <span style="color: #ff0000">*</span>区域编号：</td>
                    <td class="Rtd">
                        <asp:TextBox ID="txtAreaId" ReadOnly="true" runat="server" Width="200px" CssClass="Enter" style="color:Gray;" MaxLength="100" >自动生成</asp:TextBox>
                        </td>
                </tr>
                <tr>
                    <td class="Ltd">
                        <span style="color: #ff0000">*</span>区域名称：</td>
                    <td class="Rtd">
                        <asp:TextBox ID="txtName" runat="server" Width="200px" CssClass="Enter" MaxLength="100" ></asp:TextBox>
                        </td>
                </tr>
                <tr>
                    <td class="Ltd">父级区域：</td>
                    <td class="Rtd">
                        <asp:DropDownList ID="ddlPid" runat="server" Width="204px">
                ...
                <tr>
                    <td class="Ltd">排序：</td>
                    <td class="Rtd">
                        <asp:TextBox ID="txtSort" runat="server" Width="200px" CssClass="Enter" MaxLength="100">0</asp:TextBox>
                        </td>
                </tr>
                <tr>
                    <td class="Ltd">热门城市：</td>
                    <td class="Rtd">
                        <asp:CheckBox ID="cbHot" runat="server" Text="选择后，显示到首页热门城市" />
                        </td>
                </tr>
               <tr class="ButBox">
