<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddMarket.aspx.cs" Inherits="AppModules_Sysadmin_Base_AddMarket" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function check() {
            var id = $("#txtMarketId").val();
            var name = $("#txtMarketName").val();
            ...
            if (id == "" || id == null) {
                ...
                if (!/[@#\$%\^&\*<\>[\]{\}!,\;]+/g.test(id)) {
                    if (oldId == "" || oldId == null || id != oldId) {//是进行添加或编号被修改
                        var str = $.ajax({ url: "MarketHandler.ashx?flag=isexist&id=" + id + "", async: false }).responseText;
                        if (str === "true") {
                            alert("此编号已经存在!");
                            return false;
                        }
...
<body>
    ...
    <div id="right">
            ...
            <div class="applica_di">
                ...
                <tr>
                    <td class="Ltd">
                        <span style="color: #ff0000">*</span>市场编号：</td>
                    <td class="Rtd">
                        <asp:TextBox ID="txtMarketId" runat="server" Width="200px" ReadOnly="true" style="color:Gray;" CssClass="Enter" MaxLength="100" >自动生成</asp:TextBox>
                        </td>
                </tr>
                <tr>
                    <td class="Ltd">
                        <span style="color: #ff0000">*</span>市场名称：</td>
                    <td class="Rtd">
                        <asp:TextBox ID="txtMarketName" runat="server" Width="200px" CssClass="Enter" MaxLength="100" ></asp:TextBox>
                        </td>
                </tr>
                <tr>
