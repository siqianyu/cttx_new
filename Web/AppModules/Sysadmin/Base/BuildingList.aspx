<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BuildingList.aspx.cs" Inherits="AppModules_Sysadmin_Base_BuildingList" %>
...
<script language="javascript" type="text/javascript">
    jQuery("#startech_table_jqgrid").jqGrid({
        ...
        colModel: [
            { name: 'Building_id', index: 'Market_id', width: 50, align: 'center' },
            { name: 'Building_name', index: 'Market_name', width: 70, align: 'left' },
