<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MemberList_Free.aspx.cs"
    Inherits="MemberList_Free" %>
...
<script language="javascript" type="text/javascript">
    jQuery("#startech_table_jqgrid").jqGrid({
        url: 'MemberPayTypeHandler.ashx?flag=list&tag=free',
        datatype: "json",
        colNames: ['编号', '用户名','公司名称', '剩余消费点', '注册时间','会员状态', '操作'],
        colModel: [
            ...
            { name: 'freeMoenyAccount', index: 'freeMoenyAccount', width: 50 },
    ...
    function grid_search() {
        ...
        jQuery("#startech_table_jqgrid").jqGrid('setGridParam', { url: "MemberPayTypeHandler.ashx?flag=list&tag=free&searchfilter=" + _searchfilter + "", page: 1 }).trigger("reloadGrid");
    }
