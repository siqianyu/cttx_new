<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddMsgSup.aspx.cs" Inherits="AppModules_Sysadmin_ShortMsg_AddMsgSup" ValidateRequest="false" %>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function Check() {
            ...
            var ddlParentCategory = document.getElementById("<%=ddlParentCategory.ClientID %>");
            var txtKey = document.getElementById("<%=txtKey.ClientID %>");
            var txtSecret = document.getElementById("<%=txtSecret.ClientID %>");
            var txtSmsSign = document.getElementById("<%=txtSmsSign.ClientID %>");
            if (txtTitle.value == "") {
                alert("供应名称不能为空！");
                txtTitle.focus();
                return false;
            ...
            if (txtKey.value == "") {
                if (ddlParentCategory.value == "ali") {
                    alert("阿里云key不能为空！");
                    txtKey.focus();
                    return false;
                }
        ...
        <div id="right" style="width: 100%; margin: 0 auto; font-family: 微软雅黑;">
            ...
            <div class="applica_di">
                <table cellpadding="0" cellspacing="1" class="ViewBox" id="table_datalist" style="width: 100%; line-height: 30px;">
                    <tr>
                        ...
                        <td class="Rtd">
                            <asp:DropDownList ID="ddlParentCategory" runat="server">
                                <asp:ListItem Value="ali" Text="ali"></asp:ListItem>
                                <asp:ListItem Value="yunpian" Text="yunpian"></asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        <td class="Ltd">
                            <span class="red">*</span>供应名称：
                        </td>
                        <td class="Rtd">
                    ...
                    <tr>
                        <td class="Ltd">
                            <span class="red">*</span>Key：
                        </td>
                        <td class="Rtd">
                            <asp:TextBox ID="txtKey" runat="server" Width="200px" CssClass="input_add"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="Ltd">
                            <span class="red">*</span>Secret：
                        </td>
                        <td class="Rtd">
                            <asp:TextBox ID="txtSecret" runat="server" Width="200px" CssClass="input_add"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="Ltd">
                            <span class="red">*</span>签名：
                        </td>
                        <td class="Rtd">
                            <asp:TextBox ID="txtSmsSign" runat="server" Width="200px" CssClass="input_add"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="Ltd">
                        ...
                        <td class="Rtd">
                            <asp:TextBox ID="txtSort" runat="server" Width="200px" CssClass="input_add" Text="0"></asp:TextBox>
                        </td>
                    </tr>
