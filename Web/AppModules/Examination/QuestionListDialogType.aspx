<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QuestionListDialogType.aspx.cs" Inherits="AppModules_Examination_QuestionListDialogType" %>
...
<body>
    ...
    <asp:HiddenField runat="server" ID="hidTestSysnumber" />
        ...
        <tr>
            ...
            <td valign="top">
                <iframe frameborder="0" scrolling="auto" name="categoryGoodsList" style='width: 100%;
                    height: 1000px;' id='categoryGoodsList' src='QuestionListDialog.aspx?testSysnumber=<%=this.testSysnumber %>&courseId=<%=this.courseId %>'>
                </iframe>
            </td>
        </tr>
    </table>
