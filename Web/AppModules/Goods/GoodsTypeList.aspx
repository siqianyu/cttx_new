<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GoodsTypeList.aspx.cs" Inherits="AppModules_Goods_GoodsTypeList" %>
    ...
    <script type="text/javascript">
        ...
        function add_method() {
            $.layer({
                ...
                title: ['添加', true],
                maxmin: true,
                iframe: { src: 'AddGoodsType.aspx?r=' + Math.random() },
        ...
        function edit_method(id) {
            $.layer({
                ...
                title: ['修改', true],
                maxmin: true,
                iframe: { src: 'AddGoodsType.aspx?id=' + id },
                area: [document.body.scrollWidth - 20, $(document).height()],
                offset: ['0px', ''],
                close: function (index) {
                    //layer.msg('您获得了子窗口标记：' + layer.getChildFrame('#name', index).val(), 3, 1);
