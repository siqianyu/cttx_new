<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddGoodsType.aspx.cs" Inherits="AppModules_Goods_AddGoodsType" %>
...
<body>
    ...
    <div id="right">
            ...
            <div class="applica_di">
                ...
                <tr>
                    <td class="Ltd">
                        <span style="color: #ff0000">*</span>名称：</td>
                    <td class="Rtd">
                ...
                <tr>
                    ...
                    <td class="Rtd">
                                            ...
                                            <asp:TextBox ID="txtSort" runat="server" Width="80px" CssClass="input_add">1</asp:TextBox><span
                ...
                <tr>
                    <td class="Ltd">标识：</td>
                    <td class="Rtd">
                        <asp:CheckBox ID="cbIsVisible" runat="server" Text="推荐"  />
                        （是否推荐）
                        </td>
                </tr>
                <tr>
                ...
                <tr style="display:none">
                    <td class="Ltd">
                        描述：</td>
                    <td class="Rtd">
                        <asp:TextBox ID="TextBox1" runat="server" Width="600px" CssClass="Enter" 
                            MaxLength="100" Height="400px" TextMode="MultiLine" ></asp:TextBox>
                        </td>
                </tr>
