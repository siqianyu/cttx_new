<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GoodsAdd.aspx.cs" Inherits="ShopSeller_GoodsAdd"
            ...
            <div id="Addcom_Bas">
                ...
                <table border="0" cellpadding="0" cellspacing="1" class="Addcomlist ViewBox">
                    ...
                    <tr>
                        ...
                        <td class="Rtd">
                           <select runat="server" id="ddlJobType" style="display:none"><option value="Goods">课程</option></select> 
                    ...
                    <tr>
                        ...
                        <td class="Rtd">
                            ...
                            &nbsp;
                            <br />
                            <span style='color:#F00;'>说明：图片建议尺寸：335×200,建议使用PNG格式</span>
                            <div
                    ...
                    <tr>
                        ...
                        <td class="Rtd" style="text-align: left;" >
                            <asp:CheckBox ID="cbIsRec" Text="推荐" runat="server" />（推荐显示到首页）&nbsp;
                            <asp:CheckBox ID="cbIsNew" Text="最新" runat="server" Visible="false" />&nbsp;
                            <asp:CheckBox ID="cbIsHot" Text="热门 " runat="server" Visible="false" />&nbsp;
                        </td>
                     ...
                     <td class="Ltd">
                        ...
                        <td class="Rtd" style="text-align: left;">
                            ...
                            <asp:ListItem Value="普通课程">普通课程</asp:ListItem>
                            <asp:ListItem Value="虚拟组合课程">虚拟组合课程</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr style="display: none">
                    ...
                    <tr>
                        ...
                        <td class='Rtd' colspan='3'>
                            ...
                            <%}
                               ...
                               { %>
                            <a href="javascript:void(0)" style="color:#dddddd">请先保存课程基本信息</a>
                            <%} %>
                            <br />
                            <div id='slideImgList'>
                    ...
                    <tr>
                        ...
                        <td class='Rtd' colspan='3'>
                            <asp:TextBox TextMode="MultiLine" ID="hzst_ckeditor" runat="server" Visible="true"
                                Style='width: 700px; height: 150px;'></asp:TextBox>
                        </td>
                    </tr>
                ...
                <script>
                    (function () {
                        if ("<%=this.id %>" != "") {
                            ...
                            ajaxStr += "<tr><td class='Rtd ButBox' colspan='4' style='width:98%;padding:5px;text-align:center;height:45px;'><input style='width: 135px;' type='button' class='CommonButon' value='编辑课程属性' onclick='editMore()'  /></td></tr>";
...
//    }
    ...
    function editMore() {
        var goodsId = "<%=this.id %>";
        if (goodsId == "") { alert('请先保存课程信息，再进行属性编辑'); return false; }
        ...
        if (returnValue != null) {
            ...
            ajaxStr += "<tr><td class='Rtd ButBox' colspan='4' style='width:98%;padding:5px;text-align:center;height:45px;'><input type='button' class='CommonButon' value='编辑课程属性' onclick='editMore()'  /></td></tr>";
            $("#table_moreproperty").html(ajaxStr);
        }
        return false;
    }
    ...
    function editeFormate(flag) {
        var goodsId = "<%=this.id %>";
        if (goodsId == "") { alert('请先保存课程信息，再进行规格编辑'); return false; }
...
//    });
    ...
    <script language="javascript">
        $(function () {
            var editor = CKEDITOR.replace("hzst_ckeditor", { skin: "kama", width: document.body.scrollWidth - 300, height: 380 });
        });
    </script>