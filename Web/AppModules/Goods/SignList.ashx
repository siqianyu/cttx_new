...
public class SignList : IHttpHandler {
    ...
    public string Delete(string goodsid)
    {
        ...
        string strSQL = "delete T_Goods_Sign where signid='" + gid + "';";
    ...
    public void EditDataSource(ref DataTable dt)
    {
        ...
        {
            strSQL += "select * from T_Goods_Sign where signid in (select signid from T_Goods_SignBind where goodsid='" + dr["goodsid"] + "');";
        }
