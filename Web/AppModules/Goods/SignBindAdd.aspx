<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SignBindAdd.aspx.cs" Inherits="AppModules_Goods_SignBindAdd" %>
...
<body>
    ...
    <div id="right">
            ...
            <div class="applica_di">
                ...
                <tr>
                    <td class="Ltd">
                        <span style="color: #ff0000">*</span>任务名：</td>
                    <td class="Rtd">
                ...
                <tr>
                    <td class="Ltd">
                        <span style="color: #ff0000"></span>任务编号：</td>
                    <td class="Rtd">
                    <asp:Label ID="llCode" runat="server" Text="Label"></asp:Label>
                ...
                <tr>
                    <td class="Ltd">
                        <span style="color: #ff0000"></span>使用标签：</td>
                    <td class="Rtd">
                        <asp:Literal ID="llSign" runat="server"></asp:Literal>
