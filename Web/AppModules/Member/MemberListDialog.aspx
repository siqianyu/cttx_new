<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MemberListDialog.aspx.cs" Inherits="AppModules_Member_MemberListDialog" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript">
        function select_member(mid, truename) {
            //alert(mid + truename);
            parent.add_member_info(mid, truename);
        }
    </script>
</head>
<body>
    ...
    <div class="SosoBar Left">
        <table>
            <tr>
                <td style=" width:80%">
                    <div class="divSearch" style='width:400px'>
...
<script language="javascript" type="text/javascript">
    jQuery("#startech_table_jqgrid").jqGrid({
        ...
        colModel: [
            ...
            { name: 'Sex', index: 'Sex', width: 60, align: 'center', hidden: true },
            ...
            { name: 'isUse', index: 'isUse', width: 60, align: 'center', hidden: true },
            ...
            for (var i = 0; i < ids.length; i++) {
                ...
                if (rowData) {
                    ...
                    var writeData = {
                        ...
                        cmd_col: "<input type='button' class='CommonButon' value='选择' onclick=\"select_member('" + rowData.MemberId + "','" + rowData.TrueName + "')\">"
                    }
