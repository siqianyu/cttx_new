<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MemberShareList.aspx.cs" Inherits="AppModules_Member_MemberShareList" %>
...
<script language="javascript" type="text/javascript">
    jQuery("#startech_table_jqgrid").jqGrid({
        url: 'MemberHandler.ashx?flag=sharelist<%=categoryId %>',
        datatype: "json",
        colNames: ['会员编号', '会员名', '手机号码', '真实姓名', '分享数量', '操作'],
        colModel: [
            ...
            { name: 'ShareTotal', index: 'ShareTotal', width: 60, align: 'center' },
    ...
    function grid_search() {
        ...
        jQuery("#startech_table_jqgrid").jqGrid('setGridParam', { url: "MemberHandler.ashx?flag=sharelist<%=categoryId %>&searchfilter=" + _searchfilter + "", page: 1 }).trigger("reloadGrid");
    }
