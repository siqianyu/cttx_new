<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WXSendMessageLog.aspx.cs" Inherits="AppModules_WXSendMessageLog" %>
        ...
        <table>
            <tr>
                <td style=" width:70%">
                    ...
                    <div class="divSearch"><div class="spanSearch" >接收人：</div><asp:DropDownList ID="ddlUsers" Width="130" runat="server"></asp:DropDownList></div>
                </td>
                <td style="width:30%">
...
<script language="javascript" type="text/javascript">
    jQuery("#startech_table_jqgrid").jqGrid({
        url: 'WXSendMessageLog.ashx?flag=list',
        datatype: "json",
