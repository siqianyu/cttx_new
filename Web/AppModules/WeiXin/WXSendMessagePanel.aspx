<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WXSendMessagePanel.aspx.cs" Inherits="AppModules_WXSendMessagePanel" %>
...
<body>
    ...
    <div class="SosoBar Left">
        ...
        <table>
            <tr>
                <td><input type="button" value="全选" onclick="select_all()" /> <input type="button" value="取消" onclick="select_all2()" />&nbsp;&nbsp;
