<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JobLogList.aspx.cs" Inherits="AppModules_IACenter_JobLogList" %>
...
<body>
    ...
    <div class="SosoBar Left">
        <table>
            <tr>
                <td style=" width:80%">
                    <div class="divSearch"><div class="spanSearch" >用户：</div><input style="width: 100px;" id="txtUserName" /></div>
                </td>
                <td style=" width:20%">
...
<script language="javascript" type="text/javascript">
    jQuery("#startech_table_jqgrid").jqGrid({
        url: 'JobLog.ashx?flag=list',
        datatype: "json",
        colNames: ['','用户名', '签到时间', '任务编号','', '地址','备注', '操作'],
        colModel: [
            { name: 'RecordId', index: 'AdId', width: 70, hidden: true },
            { name: 'MemberId', index: 'title', width: 30, align: 'center' },
            { name: 'RecordTime', index: 'DisplayMode', width: 30, align: 'center' },
   		    { name: 'GoodsId', index: 'Link', align: 'left' },
            { name: 'JobAddressCode', index: 'CategoryId', width: 50, align: 'center', hidden: true },
            { name: 'JobAddress', index: 'sort', width: 30, align: 'center', hidden: true },
            { name: 'RecordInfo', index: 'sort', width: 30, align: 'center' },
