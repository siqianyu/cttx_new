<%@ WebHandler Language="C#" Class="MessageLog" %>
...
public class MessageLog : IHttpHandler
{
    ...
    {
        string table = " (select sysnumber, a.MemberId, type, createTime, title, remark,b.TrueName from T_Log_Message a,T_Member_Info b where a.MemberId=b.MemberId) vv";
