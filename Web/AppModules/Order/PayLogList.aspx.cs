...
public partial class AppModules_IACenter_PayLogList : StarTech.Adapter.StarTechPage
{
    ...
    protected void btnExcel_Click(object sender, EventArgs e)
    {
        ...
        string filter = " 1=1 ";
        if (this.txtDateBegin.Value != "") { filter += " and payTime >= '" + this.txtDateBegin.Value + "'"; }
        if (this.txtDateEnd.Value != "") { filter += " and payTime < '" + DateTime.Parse(this.txtDateEnd.Value).AddDays(1) + "'"; }
