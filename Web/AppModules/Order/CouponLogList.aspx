<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CouponLogList.aspx.cs" Inherits="AppModules_IACenter_PayLogList" %>
...
<body>
    ...
    <div class="SosoBar Left">
        <table>
            <tr>
                <td style=" width:80%">
                    <div class="divSearch" style="width:260px;"><div class="spanSearch" >电话：</div><input style="width: 170px;" id="txtTel" /></div>
...
<script language="javascript" type="text/javascript">
    ...
    function grid_search() {
        ...
        jQuery("#startech_table_jqgrid").jqGrid('setGridParam', { url: "CouponLog.ashx?flag=list&searchfilter=" + _searchfilter + "", page: 1 }).trigger("reloadGrid");
    }
