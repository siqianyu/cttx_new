...
public partial class AppModules_Menu_SignAdd : StarTech.Adapter.StarTechPage
{
    protected string id = "";
    ...
    {
        string strSQL = "select * from T_Menu_Sign where signid="+id+";";
    ...
    protected void btnSave_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (id == "")
        {
            ...
            strSQL = "insert T_Menu_Sign values('" + signname + "','" + remark + "','" + atime + "');";
        }
        else
        {
            strSQL = "update T_Menu_Sign set signName='" + signname + "',remark='" + remark + "' where signid='" + id + "';";
        }
