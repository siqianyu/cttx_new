...
{
    public class DalIACenter_MarketUser
    {
        ...
        public int Add(ModIACenter_MarketUser model)
        {
            ...
            strSql.Append("insert into IACenter_Market_User(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update IACenter_Market_User set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete IACenter_Market_User ");
            strSql.Append(" where uniqueId=@uniqueId ");
            SqlParameter[] parameters = {
					new SqlParameter("@uniqueId", SqlDbType.Int,4)};
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * from IACenter_Market_User ");
            strSql.Append(" where uniqueId=@uniqueId ");
            SqlParameter[] parameters = {
					new SqlParameter("@uniqueId", SqlDbType.Int,4)};
            parameters[0].Value = uniqueId;

            ModIACenter_MarketUser model = new ModIACenter_MarketUser();
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM IACenter_Market_User ");
            if (strWhere.Trim() != "")
            {
