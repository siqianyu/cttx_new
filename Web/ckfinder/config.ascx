...
<script runat="server">
    ...
    public override void SetConfig()
    {
        ...
        string SaveFile = "~/userfiles/" + DateTime.Now.ToString("yyyy/MM/dd/").Replace("-", "/");
        string phydic = HttpContext.Current.Server.MapPath(SaveFile);
        ...
        //else
        //{
        //    System.IO.Directory.CreateDirectory(phydic + "/视频");
        //    System.IO.Directory.CreateDirectory(phydic + "/企业");
        //    System.IO.Directory.CreateDirectory(phydic + "/拍卖会");
        //}
        BaseUrl = SaveFile;
        //BaseUrl = "~/userfiles/";//默认的文件上传位置
        ...
        //PluginSettings.Add("Watermark_source", "Images/logo.png");
